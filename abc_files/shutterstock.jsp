		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if (usi_app.is_enabled && usi_date.is_between('2024-11-29T00:01:00-08:00', '2024-12-02T23:59:00-08:00')) {
						if(language_key.match('english') != null) language_key = '_english'
						usi_app.messaging = usi_app.get_messaging('bfcm_2024');

						if(user_type == 'new') {
							if ((usi_app.is_cart_page)  || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) {
								usi_commons.log('[usi] 55451 BFCM 2024 - 25% Off New Users Active Cart')
								usi_commons.load_view("32p3lJkrfMnAtnz7LIkPXjl", "55451", usi_commons.device + language_key)
								return;
							} else {
								usi_commons.log('[usi] 55449 BFCM 2024 - 25% Off New Users Pre Cart')
								usi_commons.load_view("32ZzZFTnCttDdAQk0hYfRCr", "55449", usi_commons.device + language_key)
								return;
							}
						} else if ((user_type == 'reconversion' || user_type == 'extension') && language_key.match('english') != null) {
							if ((usi_app.is_cart_page)  || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) {
								usi_commons.log('[usi] 55449 BFCM 2024 - 25% Off Return Users ActiveCart')
								usi_commons.load_view("b9aqA6pKfIv3w2R5d8f3ImP", "55455", usi_commons.device + language_key)
								return;
							} else {
								usi_commons.log('[usi] 55449 BFCM 2024 - 25% Off Return Users Pre Cart')
								usi_commons.load_view("Q6j1KZCQZXZlDIpbQofAqYE", "55453", usi_commons.device + language_key)
								return;
							}
						}
					}
